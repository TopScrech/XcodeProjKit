...
public class PBXProject: PBXContainer, PBXBuildConfigurationListable {
    ...
    public var developmentRegion: String? {
        self.string(PBXKeys.developmentRegion)
    }
    
    public var hasScannedForEncodings: Bool {
        self.bool(PBXKeys.hasScannedForEncodings)
    }
    
    public var knownRegions: [String] {
        self.strings(PBXKeys.knownRegions)
    }
    
    public var targets: [PBXNativeTarget] {
        self.objects(PBXKeys.targets)
    }
    
    public var mainGroup: PBXGroup? {
        self.object(PBXKeys.mainGroup)
    }
    ...
    public var packageReferences: [XCRemoteSwiftPackageReference] {
        self.objects(PBXKeys.packageReferences)
    }
...
extension PBXProject {
    ...
    public var attributes: [String: Any]? {
        get {
            self.fields["attributes"] as? [String: Any]
        } set {
    ...
    public struct Version: Comparable, CustomStringConvertible {
        ...
        public var description: String {
            "\(self.major).\(self.minor)" // XXX padding on major or not?
        }
        
        public var openStep: String {
            "\(String(format: "%02d", self.major))\(String(format: "%02d", self.minor))"
        }
    }
    
    public var lastUpgradeCheck: Version? {
        get {
            Version(attribute(.lastUpgradeCheck) as? String)
        } set {
    ...
    public var lastSwiftUpdateCheck: Version? {
        get {
            Version(attribute(.lastSwiftUpdateCheck) as? String)
        } set {
            if let version = newValue?.openStep {
    ...
    public var organizationName: String? {
        get {
            attribute(.organizationName) as? String
        } set {
