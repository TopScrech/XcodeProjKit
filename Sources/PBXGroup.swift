...
public class PBXGroup: PBXReference {
    ...
    public var children: [PBXReference] {
        self.objects(PBXKeys.children)
    }
    
    public var subGroups: [PBXGroup] {
        self.children.of(type: PBXGroup.self)
    }
    
    public var fileRefs: [PBXFileReference] {
        self.children.of(type: PBXFileReference.self)
    }
    
    public var usesTabs: Bool? {
        self.bool(PBXKeys.usesTabs)
    }
#endif
}
